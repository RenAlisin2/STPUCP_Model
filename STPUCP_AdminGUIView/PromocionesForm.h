...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->IdUsuario = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			this->textIdUsuario = (gcnew System::Windows::Forms::TextBox());
			...
			this->menuStrip1->Size = System::Drawing::Size(644, 30);
			...
			// txtNombrePromo
			// 
			this->txtNombrePromo->Location = System::Drawing::Point(224, 121);
			...
			this->lblApellidoPaterno->Location = System::Drawing::Point(41, 124);
			...
			// txtPorcentajePromo
			// 
			this->txtPorcentajePromo->Location = System::Drawing::Point(224, 85);
			...
			this->dgvPromo->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(4) {
				this->PromoID, this->PorcentajePromo,
					this->NombrePromo, this->IdUsuario
			});
			this->dgvPromo->Location = System::Drawing::Point(23, 218);
			this->dgvPromo->Margin = System::Windows::Forms::Padding(4);
			this->dgvPromo->Name = L"dgvPromo";
			this->dgvPromo->RowHeadersWidth = 51;
			this->dgvPromo->Size = System::Drawing::Size(551, 328);
			...
			// IdUsuario
			// 
			this->IdUsuario->HeaderText = L"IdUsuario";
			...
			// btnEliminar
			// 
			this->btnEliminar->Location = System::Drawing::Point(356, 182);
			...
			// btnModificar
			// 
			this->btnModificar->Location = System::Drawing::Point(201, 182);
			...
			// btnAgregar
			// 
			this->btnAgregar->Location = System::Drawing::Point(45, 182);
			...
			// txtIdPromo
			// 
			this->txtIdPromo->Location = System::Drawing::Point(224, 48);
			...
			this->lblNombre->Location = System::Drawing::Point(41, 89);
			...
			this->lblId->Location = System::Drawing::Point(41, 57);
			...
			this->label1->Location = System::Drawing::Point(44, 159);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(89, 16);
			this->label1->TabIndex = 29;
			this->label1->Text = L"ID del usuario";
			// 
			// textIdUsuario
			// 
			this->textIdUsuario->Location = System::Drawing::Point(224, 153);
			this->textIdUsuario->Name = L"textIdUsuario";
			this->textIdUsuario->Size = System::Drawing::Size(185, 22);
			this->textIdUsuario->TabIndex = 30;
			// 
			// PromocionesForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(644, 565);
...
private: System::Void btnAgregar_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	promocion->IdUsuario = Int32::Parse(textIdUsuario->Text);
	...
	RefreshGrid();
	   ...
	   void RefreshGrid() {
		   ...
		   for (int i = 0; i < promocionList->Count; i++) {
			   ...
			   dgvPromo->Rows->Add(gcnew array<String^> {"" + promocion->Id, "" + promocion->Porcentaje, promocion->NombrePromo,""+ promocion->IdUsuario});
		   }
	   }
...
private: System::Void dgvPromo_CellClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
	...
	textIdUsuario->Text = " " +promocion->IdUsuario;
